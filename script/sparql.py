...
def formulate_main_query(property):
    main_query = 'select distinct ?source ?source_l ?prop_l ?prop_value ?know_as ?id_l ?id ?id_value where{\
...
def process_main_query(data, ids):
    ...
    for item in data:
        property_label = item['prop_l']['value']
        source = item['source']['value']
        prop_value = item['prop_value']['value']
        know_as = item['know_as']['value'] if 'know_as' in item.keys() else None
        subject_l = item['source_l']['value']
        id = item['id']['value']
        id_l = item['id_l']['value']
        id_value = item['id_value']['value']
        ...
        result[source][id_l].append(id_value)
